-- Migration: Add get_session_cards RPC function for optimized session loading
-- This reduces session loading from ~36 queries to 1 RPC call

-- =============================================================================
-- get_session_cards: Fetch learning cards with all data needed for a session
...
Returns cards with embedded vocabulary, meanings, cues, and eligibility flags
for cue type selection. Replaces multiple queries in session planning.';
