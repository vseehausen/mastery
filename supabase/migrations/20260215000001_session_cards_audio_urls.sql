-- Migration: Add audio_urls to get_session_cards
-- Date: 2026-02-15
--
-- Changes:
-- 1. Add audio_urls JSONB to get_session_cards return
...
Includes usage_examples, audio_urls, updated cue type lists for novel_cloze and usage_recognition.';
